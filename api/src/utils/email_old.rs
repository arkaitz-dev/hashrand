    ...
    <div class="container" role="main">
        ...
        <main class="content">
            ...
            <div style="text-align: center;" role="group" aria-label="Authentication action">
                <a href="{}" class="button" role="button" aria-label="Access HashRand securely">
                    🚀 Access HashRand
                </a>
            </div>
    ...
    <div class="container" role="main">
        ...
        <main class="content">
            ...
            <div style="text-align: center;" role="group" aria-label="Acción de autenticación">
                <a href="{}" class="button" role="button" aria-label="Acceder a HashRand de forma segura">
                    🚀 Acceder a HashRand
                </a>
            </div>
    ...
    <div class="container" role="main">
        ...
        <main class="content">
            ...
            <div style="text-align: center;" role="group" aria-label="Action d'authentification">
                <a href="{}" class="button" role="button" aria-label="Accéder à HashRand en toute sécurité">
                    🚀 Accéder à HashRand
                </a>
            </div>
