<script lang="ts">
	...
	$: alphabetOptions = [
		{ value: 'full-with-symbols' as const, label: $_('alphabets.full-with-symbols'), description: $_('password.maxSecurityDescription') },
		{ value: 'no-look-alike' as const, label: $_('alphabets.no-look-alike'), description: $_('password.easyReadDescription') }
	];
