<script lang="ts">
	...
	onMount(async () => {
		...
		// ⚠️ PROJECT-SPECIFIC RESTRICTION (can be removed in other projects)
		...
		if (!searchParams.has('p')) {
			logger.warn('[SharedSecret] Direct access blocked - missing encrypted params, redirecting to home');
			goto('/');
			return;
		}
