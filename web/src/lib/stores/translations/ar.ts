...
export const ar: I18nTexts = {
	common: {
		...
		copied: 'تم النسخ!',
		share: 'مشاركة',
		shareToCreateSecret: 'مشاركة لإنشاء سر مشترك',
	...
	mnemonic: {
		title: 'العبارات التذكيرية BIP39',
	...
	auth: {
		...
		tokenRefreshError: '❌ خطأ في تجديد الجلسة',
	...
	sharedSecret: {
		...
		emailSameAsSender: 'لا يمكن أن يكون البريد الإلكتروني للمستلم هو نفسه بريد المرسل',
		...
		senderOtp: 'OTP للمشاركة',
		otpInstructions: 'شارك هذا الرمز مع المستلم عبر قناة منفصلة',
		firstAccessAt: 'الوصول الأول',
		notAccessedYet: 'لم يتم الوصول بعد',
