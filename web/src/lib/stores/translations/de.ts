...
export const de: I18nTexts = {
	common: {
		...
		copied: 'Kopiert!',
		share: 'Teilen',
		shareToCreateSecret: 'Teilen, um ein geteiltes Geheimnis zu erstellen',
		...
		clickToSelect: 'Klicken Sie auf das Textfeld, um den Inhalt zu kopieren',
	...
	sharedSecret: {
		...
		senderOtp: 'OTP zum Teilen',
		otpInstructions: 'Teilen Sie diesen Code über einen separaten Kanal mit dem Empfänger',
		firstAccessAt: 'Erster Zugriff',
		notAccessedYet: 'Noch nicht zugegriffen',
