...
export const eu: I18nTexts = {
	common: {
		...
		copied: 'Kopiatuta!',
		share: 'Partekatu',
		shareToCreateSecret: 'Partekatu sekretu partekatua sortzeko',
		autoGenerated: 'Automatikoki sortua',
	...
	sharedSecret: {
		...
		senderEmail: 'Zure helbide elektronikoa',
		emailNotAvailable: 'Helbide elektronikoa ez dago erabilgarri - Hasi saioa',
		...
		unlimited: 'Mugagabeak',
		expiresAt: 'Iraungitzen da',
		role: 'Zure rola',
		roleSender: 'Igorlean',
		roleReceiver: 'Hartzailea',
		...
		senderOtp: 'Partekatzeko OTP',
		otpInstructions: 'Partekatu kode hau hartzailearekin beste kanal baten bidez',
		firstAccessAt: 'Lehen sarbidea',
		notAccessedYet: 'Oraindik sartu gabe',
