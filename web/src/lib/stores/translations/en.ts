...
export const en: I18nTexts = {
	common: {
		...
		copied: 'Copied!',
		share: 'Share',
		shareToCreateSecret: 'Share to create a shared secret',
		...
		clickToSelect: 'Click the text area to copy the content',
	...
	sharedSecret: {
		...
		senderOtp: 'OTP for sharing',
		otpInstructions: 'Share this code with the recipient via a separate channel',
		firstAccessAt: 'First access',
		notAccessedYet: 'Not accessed yet',
		creationError: 'Error creating secret',
		retrievalError: 'Error retrieving secret',
		accessDenied: 'Access denied: This secret belongs to another user',
