...
export const pt: I18nTexts = {
	common: {
		...
		copied: 'Copiado!',
		share: 'Partilhar',
		shareToCreateSecret: 'Partilhar para criar um segredo partilhado',
	...
	auth: {
		...
		tokenRefreshError: '❌ Erro ao renovar a sessão',
	...
	sharedSecret: {
		...
		requireOtp: 'Solicitar 9 dígitos de segurança ao destinatário',
		...
		emailSameAsSender: 'O email do destinatário não pode ser igual ao do remetente',
		...
		senderOtp: 'OTP para partilhar',
		otpInstructions: 'Partilhe este código com o destinatário por um canal separado',
		firstAccessAt: 'Primeiro acesso',
		notAccessedYet: 'Ainda não acedido',
