...
export const fr: I18nTexts = {
	common: {
		...
		copied: 'Copié !',
		share: 'Partager',
		shareToCreateSecret: 'Partager pour créer un secret partagé',
	...
	sharedSecret: {
		...
		requireOtp: 'Demander un code de sécurité à 9 chiffres au destinataire',
		...
		emailSameAsSender: "L'email du destinataire ne peut pas être identique à celui de l'expéditeur",
		...
		senderOtp: 'OTP pour partager',
		otpInstructions: 'Partagez ce code avec le destinataire par un canal séparé',
		firstAccessAt: 'Premier accès',
		notAccessedYet: 'Pas encore accédé',
