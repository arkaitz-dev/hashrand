...
export const es: I18nTexts = {
	common: {
		...
		copied: '¡Copiado!',
		share: 'Compartir',
		shareToCreateSecret: 'Compartir para crear un secreto compartido',
		...
		clickToSelect: 'Haz clic en el área de texto para copiar el contenido',
	...
	sharedSecret: {
		...
		requireOtp: 'Solicitar 9 dígitos de seguridad al receptor',
		...
		otpInstructions: 'Comparte este código con el destinatario por un canal separado',
		firstAccessAt: 'Primer acceso',
		notAccessedYet: 'Aún no accedido',
		creationError: 'Error al crear el secreto',
		retrievalError: 'Error al recuperar el secreto',
		accessDenied: 'Acceso denegado: Este secreto pertenece a otro usuario',
